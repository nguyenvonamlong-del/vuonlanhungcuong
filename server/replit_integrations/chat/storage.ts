...
export interface IChatStorage {
  ...
  createConversation(title: string, userType?: string, userId?: string, sessionId?: string): Promise<typeof conversations.$inferSelect>;
...
export const chatStorage: IChatStorage = {
  ...
  async createConversation(title: string, userType = "CUSTOMER", userId?: string, sessionId?: string) {
